...
namespace WebService
{
    ...
    internal class Program
    {
         /**
         * Question 5 TD2
         * Service Web qui implémente une méthode incr <param1_val> (qui incrémente la valeur de val).
        ...
        private static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                if (val!=null) //Méthode incr <param1_val> (qui incrémente la valeur de val) 
                {
                    string[] parameters = { val };
                    method = t.GetMethod(methodStr);
